...
extension Stripe.Customers.Customer.Sessions.Create.Request {
    public enum Components: Codable, Equatable, Sendable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            } else if let paymentElement = try container.decodeIfPresent(PaymentElement.self, forKey: .paymentElement) {
                self = .paymentElement(paymentElement)
            } else if let pricingTable = try container.decodeIfPresent(PricingTable.self, forKey: .pricingTable) {
