...
extension Stripe.Charges.Charge.PaymentMethod.Details {
  public struct Bancontact: Codable, Hashable, Sendable {
    ...
    public init(
      ...
      preferredLanguage: Stripe.Charges.Charge.PaymentMethod.Details.BancontactPreferredLanguage? =
        nil,
...
extension Stripe.Charges.Charge.PaymentMethod.Details {
  public struct CardThreeDSecure: Codable, Hashable, Sendable {
    ...
    public init(
      ...
      resultReason: Stripe.Charges.Charge.PaymentMethod.Details.CardThreeDSecure.ResultReason? =
        nil,
      version: String? = nil
    ) {
...
extension Stripe.Charges.Charge.PaymentMethod.Details {
  public struct CardPresentReceipt: Codable, Hashable, Sendable {
    ...
    public init(
      accountType: Stripe.Charges.Charge.PaymentMethod.Details.CardPresentReceipt.AccountType? =
        nil,
...
extension Stripe.Charges.Charge.PaymentMethod.Details.InteracPresent {
  public struct Receipt: Codable, Hashable, Sendable {
    ...
    public init(
      accountType: Stripe.Charges.Charge.PaymentMethod.Details.InteracPresent.Receipt.AccountType? =
        nil,
      applicationCryptogram: String? = nil,
      applicationPreferredName: String? = nil,
      authorizationCode: String? = nil,
