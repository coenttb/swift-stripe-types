...
extension Stripe.Billing.UsageRecords {
    ...
    public struct Client: Sendable {
        ...
        @DependencyEndpoint
        public var create: @Sendable (_ subscriptionItemId: Stripe.Billing.SubscriptionItems.SubscriptionItem.ID, _ request: Create.Request) async throws -> UsageRecord
