...
extension Stripe.Billing.SubscriptionItems {
    ...
    public enum API: Equatable, Sendable {
        ...
        case update(id: Stripe.Billing.Subscription.Item.ID, request: Stripe.Billing.SubscriptionItems.Update.Request)
        ...
        public var body: some URLRouting.Router<Stripe.Billing.SubscriptionItems.API> {
            OneOf {
                ...
                URLRouting.Route(.case(Stripe.Billing.SubscriptionItems.API.create)) {
                    ...
                    Body(.form(Stripe.Billing.SubscriptionItems.Create.Request.self, decoder: .stripe, encoder: .stripe))
                }
                ...
                URLRouting.Route(.case(Stripe.Billing.SubscriptionItems.API.update)) {
                    ...
                    Body(.form(Stripe.Billing.SubscriptionItems.Update.Request.self, decoder: .stripe, encoder: .stripe))
                }
