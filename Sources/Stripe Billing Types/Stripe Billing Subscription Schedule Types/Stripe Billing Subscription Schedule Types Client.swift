...
extension Stripe.Billing.Subscription.Schedule {
    ...
    public struct Client: Sendable {
        ...
        @DependencyEndpoint
        public var create:
            @Sendable (_ request: Stripe.Billing.Subscription.Schedule.Create.Request) async throws
                ->
        ...
        @DependencyEndpoint
        public var retrieve:
            @Sendable (_ id: Stripe.Billing.Subscription.Schedule.ID) async throws ->
                Stripe.Billing.Subscription.Schedule
        ...
        public var update:
            ...
            ) async throws -> Stripe.Billing.Subscription.Schedule

        // https://docs.stripe.com/api/subscription_schedules/list.md
        @DependencyEndpoint
        public var list:
            @Sendable (_ request: Stripe.Billing.Subscription.Schedule.List.Request) async throws ->
