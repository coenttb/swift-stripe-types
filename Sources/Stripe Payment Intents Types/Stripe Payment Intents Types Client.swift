...
extension Stripe.PaymentIntents {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var create:
      @Sendable (_ request: Stripe.PaymentIntents.Create.Request) async throws ->
    ...
    public var update:
      ...
      ) async throws -> Stripe_Types_Shared.Stripe.PaymentIntents.PaymentIntent

    // https://docs.stripe.com/api/payment_intents/retrieve.md
    @DependencyEndpoint
    public var retrieve:
      @Sendable (_ id: Stripe_Types_Shared.Stripe.PaymentIntents.PaymentIntent.ID) async throws ->
        Stripe_Types_Shared.Stripe.PaymentIntents.PaymentIntent

    // https://docs.stripe.com/api/payment_intents/list.md
    @DependencyEndpoint
    public var list:
      @Sendable (_ request: Stripe.PaymentIntents.List.Request) async throws ->
    ...
    @DependencyEndpoint
    public var search:
      @Sendable (_ request: Stripe.PaymentIntents.Search.Request) async throws ->
