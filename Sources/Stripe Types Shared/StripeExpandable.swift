...
extension KeyedDecodingContainer {
    ...
    public func decode<U, ID>(_ type: Expandable<U, ID>.Type, forKey key: Self.Key) throws -> Expandable<U, ID> where U: Codable {
...
public typealias ExpandableOf<Model: Codable> = Expandable<Model, Model.ID> where Model:Identifiable, Model.ID: Codable & Hashable & Sendable
...
@propertyWrapper
public struct DynamicExpandable<A: Codable & Hashable & Sendable, B: Codable & Hashable & Sendable>: Codable & Hashable & Sendable {
