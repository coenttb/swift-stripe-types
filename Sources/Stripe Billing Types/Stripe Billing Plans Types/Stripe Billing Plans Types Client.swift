...
extension Stripe.Billing.Plans {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var create:
      @Sendable (_ request: Stripe.Billing.Plans.Create.Request) async throws -> Stripe.Billing.Plan
    ...
    @DependencyEndpoint
    public var delete:
      @Sendable (_ id: Stripe.Billing.Plan.ID) async throws -> DeletedObject<Stripe.Billing.Plan>
  }
}
