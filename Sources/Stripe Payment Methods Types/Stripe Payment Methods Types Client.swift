...
extension Stripe.PaymentMethods.Client {
    public func create(_ request: Stripe.PaymentMethods.PaymentMethods.Create.Request) async throws -> Stripe.PaymentMethods.PaymentMethod {
        try await self.paymentMethods.create(request)
    }
    public func retrieve(_ id: Stripe.PaymentMethods.PaymentMethod.ID) async throws -> Stripe.PaymentMethods.PaymentMethod {
        try await self.paymentMethods.retrieve(id)
    }
    public func update(_ id: Stripe.PaymentMethods.PaymentMethod.ID, _ request: Stripe.PaymentMethods.PaymentMethods.Update.Request) async throws -> Stripe.PaymentMethods.PaymentMethod {
        try await self.paymentMethods.update(id, request)
    }
    public func list(_ request: Stripe.PaymentMethods.PaymentMethods.List.Request) async throws -> Stripe.PaymentMethods.PaymentMethods.List.Response {
        try await self.paymentMethods.list(request)
    }
    public func attach(_ id: Stripe.PaymentMethods.PaymentMethod.ID, _ request: Stripe.PaymentMethods.PaymentMethods.Attach.Request) async throws -> Stripe.PaymentMethods.PaymentMethod {
        try await self.paymentMethods.attach(id, request)
    }
    public func detach(_ id: Stripe.PaymentMethods.PaymentMethod.ID) async throws -> Stripe.PaymentMethods.PaymentMethod {
