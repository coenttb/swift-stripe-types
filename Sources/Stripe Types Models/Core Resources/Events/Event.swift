    ...
    public enum Object: Codable, Hashable, Sendable {
        ...
        public init(
            ...
            case "billing_portal.configuration":
                self = try .configuration(Stripe.Billing.Customer.Portal.Configuration(from: decoder))
            case "billing_portal.session":
                self = try .billingPortalSession(Stripe.Billing.Customer.Portal.Session(from: decoder))
            case "fee_refund":
                self = try .applicationFeeRefund(Stripe.Connect.Application.Fee.Refund(from: decoder))
            case "balance":
            ...
            case "radar.early_fraud_warning":
                self = try .earlyFraudWarning(Stripe.Fraud.EarlyFraudWarnings.EarlyFraudWarning(from: decoder))
            case "quote":
            ...
            case "subscription_schedule":
                self = try .subscriptionSchedule(Stripe.Billing.Subscription.Schedule(from: decoder))
            case "tax_rate":
