...
extension Stripe.Billing.InvoiceItems {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var retrieve:
      @Sendable (_ id: Stripe.Billing.Invoice.Item.ID) async throws -> Stripe.Billing.Invoice.Item

    // https://docs.stripe.com/api/invoiceitems/update.md
    @DependencyEndpoint
    public var update:
      @Sendable (
        _ id: Stripe.Billing.Invoice.Item.ID, _ request: Stripe.Billing.InvoiceItems.Update.Request
