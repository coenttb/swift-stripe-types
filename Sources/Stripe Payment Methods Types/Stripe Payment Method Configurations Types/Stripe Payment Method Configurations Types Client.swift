...
extension Stripe.PaymentMethodConfigurations {
    ...
    public struct Client: Sendable {
        ...
        @DependencyEndpoint
        public var create: @Sendable (_ request: Create.Request) async throws -> Stripe.PaymentMethodConfigurations.Configuration
        
        // https://docs.stripe.com/api/payment_method_configurations/retrieve.md
        @DependencyEndpoint
        public var retrieve: @Sendable (_ id: Stripe.PaymentMethodConfigurations.Configuration.ID) async throws -> Stripe.PaymentMethodConfigurations.Configuration
        
        // https://docs.stripe.com/api/payment_method_configurations/update.md
        @DependencyEndpoint
        public var update: @Sendable (_ id: Stripe.PaymentMethodConfigurations.Configuration.ID, _ request: Update.Request) async throws -> Stripe.PaymentMethodConfigurations.Configuration
