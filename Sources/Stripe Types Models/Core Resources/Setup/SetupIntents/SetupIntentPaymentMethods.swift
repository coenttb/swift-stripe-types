...
public struct SetupIntentPaymentMethodOptionsBlikMandateOptionsOffSession: Codable, Hashable, Sendable {
...
public struct SetupIntentPaymentMethodOptionsUSBankAccount: Codable, Hashable, Sendable {
    ...
    public init(
        financialConnections: SetupIntentPaymentMethodOptionsUSBankAccountFinancialConnections? = nil,
...
public struct SetupIntentPaymentMethodOptionsUSBankAccountFinancialConnections: Codable, Hashable, Sendable {
    /// The list of permissions to request. The `payment_method` permission must be included.
    public var permissions: [SetupIntentPaymentMethodOptionsUSBankAccountFinancialConnectionsPermission]?

    public init(
        permissions: [SetupIntentPaymentMethodOptionsUSBankAccountFinancialConnectionsPermission]? = nil
    ) {
