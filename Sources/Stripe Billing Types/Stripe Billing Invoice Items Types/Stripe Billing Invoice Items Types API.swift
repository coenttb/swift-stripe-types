...
extension Stripe.Billing.InvoiceItems {
    ...
    public enum API: Equatable, Sendable {
        ...
        case update(id: Stripe.Billing.Invoice.Item.ID, request: Stripe.Billing.InvoiceItems.Update.Request)
        ...
        public var body: some URLRouting.Router<Stripe.Billing.InvoiceItems.API> {
            OneOf {
                ...
                URLRouting.Route(.case(Stripe.Billing.InvoiceItems.API.create)) {
                    ...
                    Path.v1
                    Path.invoiceitems
                    Body(.form(Stripe.Billing.InvoiceItems.Create.Request.self, decoder: .stripe, encoder: .stripe))
                }
                ...
                URLRouting.Route(.case(Stripe.Billing.InvoiceItems.API.update)) {
                    ...
                    Path.invoiceitems
                    Path { Parse(.string.representing(Stripe.Billing.Invoice.Item.ID.self)) }
                    Body(.form(Stripe.Billing.InvoiceItems.Update.Request.self, decoder: .stripe, encoder: .stripe))
                }
