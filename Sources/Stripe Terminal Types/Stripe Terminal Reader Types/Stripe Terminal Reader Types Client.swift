...
extension Stripe.Terminal.Readers {
    ...
    public struct Client: Sendable {
        ...
        @DependencyEndpoint
        public var update:
            @Sendable (_ id: Reader.ID, _ request: Update.Request) async throws -> Reader
        ...
        public var processPaymentIntent:
            @Sendable (_ id: Reader.ID, _ request: ProcessPaymentIntent.Request) async throws ->
                Reader

        // https://docs.stripe.com/api/terminal/readers/process_setup_intent.md
        @DependencyEndpoint
        public var processSetupIntent:
            @Sendable (_ id: Reader.ID, _ request: ProcessSetupIntent.Request) async throws ->
                Reader
        ...
        public var confirmPaymentIntent:
            @Sendable (_ id: Reader.ID, _ request: ConfirmPaymentIntent.Request) async throws ->
                Reader

        // https://docs.stripe.com/api/terminal/readers/collect_payment_method.md
        @DependencyEndpoint
        public var collectPaymentMethod:
            @Sendable (_ id: Reader.ID, _ request: CollectPaymentMethod.Request) async throws ->
                Reader
        ...
        public var presentPaymentMethod:
            @Sendable (_ id: Reader.ID, _ request: PresentPaymentMethod.Request) async throws ->
                Reader
    }
}
