...
extension Stripe.Capital.FinancingOffer {
    ...
    public struct Client: Sendable {
        ...
        @DependencyEndpoint
        public var retrieve: @Sendable (_ id: Stripe.Capital.FinancingOffer.ID) async throws -> Stripe.Capital.FinancingOffer
        ...
        @DependencyEndpoint
        public var markDelivered: @Sendable (_ id: Stripe.Capital.FinancingOffer.ID) async throws -> Stripe.Capital.FinancingOffer
    }
}
