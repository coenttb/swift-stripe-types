...
struct CustomerBalanceTransactionRouterTests {
    ...
    func testCreateURL() throws {
        ...
        let api = Stripe.Billing.Customer.Balance.API.create(customerId: customerId, request: request)
    ...
    func testRetrieveURL() throws {
        ...
        let api = Stripe.Billing.Customer.Balance.API.retrieve(customerId: customerId, id: transactionId)
    ...
    func testUpdateURL() throws {
        ...
        let api = Stripe.Billing.Customer.Balance.API.update(customerId: customerId, id: transactionId, request: request)
    ...
    func testRouterRoundTrip() throws {
        ...
        let originalAPI = Stripe.Billing.Customer.Balance.API.create(customerId: customerId, request: request)
