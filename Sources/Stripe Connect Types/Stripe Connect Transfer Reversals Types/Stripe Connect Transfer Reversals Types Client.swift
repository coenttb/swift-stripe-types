...
extension Stripe.Connect.Transfer.Reversals {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var create:
      @Sendable (_ transferId: Stripe.Connect.Transfer.ID, _ request: Create.Request) async throws
    ...
    public var retrieve:
      @Sendable (
        _ transferId: Stripe.Connect.Transfer.ID, _ reversalId: Stripe.Connect.Transfer.Reversal.ID
    ...
    @DependencyEndpoint
    public var list:
      @Sendable (_ transferId: Stripe.Connect.Transfer.ID, _ request: List.Request) async throws ->
        List.Response
  }
}
