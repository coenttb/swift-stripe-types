...
extension Stripe.Billing.Credit.Grant {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var update:
      @Sendable (_ id: ID, _ request: Update.Request) async throws -> Stripe.Billing.Credit.Grant
    ...
    @DependencyEndpoint
    public var expire:
      @Sendable (_ id: ID, _ request: Expire.Request) async throws -> Stripe.Billing.Credit.Grant

    // https://docs.stripe.com/api/billing/credit-grant/void.md
    @DependencyEndpoint
    public var void:
      @Sendable (_ id: ID, _ request: Void.Request) async throws -> Stripe.Billing.Credit.Grant
  }
}
