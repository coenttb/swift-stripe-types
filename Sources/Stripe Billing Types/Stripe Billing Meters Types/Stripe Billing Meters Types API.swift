    ...
    public var body: some URLRouting.Router<Stripe.Billing.Meters.API> {
      OneOf {
        ...
        Route(.case(Stripe.Billing.Meters.API.deactivate)) {
          ...
          Path.deactivate
          Body(
            .form(Stripe.Billing.Meters.Deactivate.Request.self, decoder: .stripe, encoder: .stripe)
          )
        }
        ...
        Route(.case(Stripe.Billing.Meters.API.reactivate)) {
          ...
          Path.reactivate
          Body(
            .form(Stripe.Billing.Meters.Reactivate.Request.self, decoder: .stripe, encoder: .stripe)
          )
        }
      }
    }
