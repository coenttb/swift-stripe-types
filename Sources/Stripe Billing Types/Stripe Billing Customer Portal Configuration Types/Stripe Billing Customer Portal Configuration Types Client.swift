...
extension Stripe.Billing.Customer.Portal.Configuration {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var update:
      @Sendable (_ id: Stripe.Billing.Customer.Portal.Configuration.ID, _ request: Update.Request)
        async throws -> Stripe.Billing.Customer.Portal.Configuration

    // https://docs.stripe.com/api/customer_portal/configurations/list.md
    @DependencyEndpoint
    public var list:
      @Sendable (_ request: Stripe.Billing.Customer.Portal.Configuration.List.Request) async throws
        -> List.Response
  }
}
