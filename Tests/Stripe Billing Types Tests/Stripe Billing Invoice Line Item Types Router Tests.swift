...
struct BillingInvoiceLineItemRouterTests {
    ...
    func testUpdateInvoiceLineItem() throws {
        ...
        let api = Stripe.Billing.Invoice.LineItems.API.update(invoiceId: "in_123", lineItemId: "li_456", request: request)
    ...
    func testUpdateLinesOnInvoice() throws {
        ...
        let api = Stripe.Billing.Invoice.LineItems.API.updateLines(invoiceId: "in_123", request: request)
    ...
    func testRemoveLinesFromInvoice() throws {
        ...
        let api = Stripe.Billing.Invoice.LineItems.API.removeLines(invoiceId: "in_123", request: request)
