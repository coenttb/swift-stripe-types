...
extension Stripe.PaymentIntents.Create {
  ...
  public struct Request: Codable, Equatable, Sendable {
    ...
    public init(
      ...
      automaticPaymentMethods: Stripe_Types_Shared.Stripe.PaymentIntents.PaymentIntent.Automatic
        .Payment.Methods? = nil,
      confirm: Bool? = nil,
      ...
      setupFutureUsage: Stripe_Types_Shared.Stripe.PaymentIntents.PaymentIntent.SetupFutureUsage? =
        nil,
      ...
      paymentMethodData: Stripe_Types_Shared.Stripe.PaymentIntents.PaymentIntent.Payment.Method
        .Options? = nil,
      paymentMethodOptions: Stripe_Types_Shared.Stripe.PaymentIntents.PaymentIntent.Payment.Method
        .Options? = nil,
