...
extension Stripe.PaymentMethodDomains {
    ...
    public struct Client: Sendable {
        ...
        @DependencyEndpoint
        public var create: @Sendable (_ request: Create.Request) async throws -> Stripe.PaymentMethodDomain
        
        // https://docs.stripe.com/api/payment_method_domains/retrieve.md
        @DependencyEndpoint
        public var retrieve: @Sendable (_ id: Stripe.PaymentMethodDomain.ID) async throws -> Stripe.PaymentMethodDomain
        
        // https://docs.stripe.com/api/payment_method_domains/update.md
        @DependencyEndpoint
        public var update: @Sendable (_ id: Stripe.PaymentMethodDomain.ID, _ request: Update.Request) async throws -> Stripe.PaymentMethodDomain
        ...
        @DependencyEndpoint
        public var validate: @Sendable (_ id: Stripe.PaymentMethodDomain.ID) async throws -> Stripe.PaymentMethodDomain
    }
}
