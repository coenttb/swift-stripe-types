...
extension Stripe.Terminal.Readers {
    ...
    public struct Client: Sendable {
        ...
        @DependencyEndpoint
        public var processPaymentIntent: @Sendable (_ id: Reader.ID, _ request: ProcessPaymentIntent.Request) async throws -> Reader
        
        // https://docs.stripe.com/api/terminal/readers/process_setup_intent.md
        @DependencyEndpoint
        public var processSetupIntent: @Sendable (_ id: Reader.ID, _ request: ProcessSetupIntent.Request) async throws -> Reader
        
        // https://docs.stripe.com/api/terminal/readers/collect_inputs.md
        @DependencyEndpoint
        public var collectInputs: @Sendable (_ id: Reader.ID, _ request: CollectInputs.Request) async throws -> Reader
        
        // https://docs.stripe.com/api/terminal/readers/confirm_payment_intent.md
        @DependencyEndpoint
        public var confirmPaymentIntent: @Sendable (_ id: Reader.ID, _ request: ConfirmPaymentIntent.Request) async throws -> Reader
        
        // https://docs.stripe.com/api/terminal/readers/collect_payment_method.md
        @DependencyEndpoint
        public var collectPaymentMethod: @Sendable (_ id: Reader.ID, _ request: CollectPaymentMethod.Request) async throws -> Reader
        
        // https://docs.stripe.com/api/terminal/readers/refund_payment.md
        @DependencyEndpoint
        public var refundPayment: @Sendable (_ id: Reader.ID, _ request: RefundPayment.Request) async throws -> Reader
        
        // https://docs.stripe.com/api/terminal/readers/set_reader_display.md
        @DependencyEndpoint
        public var setReaderDisplay: @Sendable (_ id: Reader.ID, _ request: SetReaderDisplay.Request) async throws -> Reader
        
        // https://docs.stripe.com/api/test_helpers/terminal/readers/present_payment_method.md
        @DependencyEndpoint
        public var presentPaymentMethod: @Sendable (_ id: Reader.ID, _ request: PresentPaymentMethod.Request) async throws -> Reader
    }
}
