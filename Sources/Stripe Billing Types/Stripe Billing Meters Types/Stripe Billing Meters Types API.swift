        ...
        public var body: some URLRouting.Router<Stripe.Billing.Meters.API> {
            OneOf {
                Route(.case(Stripe.Billing.Meters.API.create)) {
                    ...
                    Path.billing
                    Path.meters
                    Body(.form(Stripe.Billing.Meters.Create.Request.self, decoder: .stripe, encoder: .stripe))
                }
                ...
                Route(.case(Stripe.Billing.Meters.API.update)) {
                    ...
                    Path.meters
                    Path { Parse(.string.representing(Stripe.Billing.Meters.Meter.ID.self)) }
                    Body(.form(Stripe.Billing.Meters.Update.Request.self, decoder: .stripe, encoder: .stripe))
                }
                ...
                Route(.case(Stripe.Billing.Meters.API.list)) {
                    ...
                    Parse(.memberwise(Stripe.Billing.Meters.List.Request.init)) {
                        Query {
                            ...
                            Optionally {
                                Field("status") { Parse(.string.representing(Stripe.Billing.Meters.Status.self)) }
                            }
                        }
                    }
                }
                ...
                Route(.case(Stripe.Billing.Meters.API.deactivate)) {
                    ...
                    Path { Parse(.string.representing(Stripe.Billing.Meters.Meter.ID.self)) }
                    Path.deactivate
                    Body(.form(Stripe.Billing.Meters.Deactivate.Request.self, decoder: .stripe, encoder: .stripe))
                }
                ...
                Route(.case(Stripe.Billing.Meters.API.reactivate)) {
                    ...
                    Path { Parse(.string.representing(Stripe.Billing.Meters.Meter.ID.self)) }
                    Path.reactivate
                    Body(.form(Stripe.Billing.Meters.Reactivate.Request.self, decoder: .stripe, encoder: .stripe))
                }
            }
        }
    }
