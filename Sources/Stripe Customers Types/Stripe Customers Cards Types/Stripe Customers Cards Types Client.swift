...
extension Stripe.Customers.Cards {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var retrieve:
      @Sendable (_ customerId: Stripe.Customers.Customer.ID, _ cardId: Card.ID) async throws -> Card

    // https://docs.stripe.com/api/cards/update.md
    @DependencyEndpoint
    public var update:
      @Sendable (
        _ customerId: Stripe.Customers.Customer.ID, _ cardId: Card.ID, _ request: Update.Request
      ) async throws -> Card
