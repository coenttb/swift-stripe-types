...
extension Stripe.Setup.Intents {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var create:
      @Sendable (_ request: Stripe.Setup.Intents.Create.Request) async throws -> Stripe.Setup.Intent

    // https://docs.stripe.com/api/setup_intents/retrieve.md
    @DependencyEndpoint
    public var retrieve:
      @Sendable (_ id: Stripe.Setup.Intent.ID) async throws -> Stripe.Setup.Intent
    ...
    public var update:
      @Sendable (_ id: Stripe.Setup.Intent.ID, _ request: Stripe.Setup.Intents.Update.Request)
        async throws -> Stripe.Setup.Intent

    // https://docs.stripe.com/api/setup_intents/list.md
    @DependencyEndpoint
    public var list:
      @Sendable (_ request: Stripe.Setup.Intents.List.Request) async throws ->
        Stripe.Setup.Intents.List.Response

    // https://docs.stripe.com/api/setup_intents/confirm.md
    @DependencyEndpoint
    public var confirm:
      @Sendable (_ id: Stripe.Setup.Intent.ID, _ request: Stripe.Setup.Intents.Confirm.Request)
        async throws -> Stripe.Setup.Intent
    ...
    public var verifyMicrodeposits:
      @Sendable (
        _ id: Stripe.Setup.Intent.ID, _ request: Stripe.Setup.Intents.VerifyMicrodeposits.Request
      ) async throws -> Stripe.Setup.Intent
  }
}
