                ...
                public struct ScheduleParam: Codable, Equatable, Sendable {
                    ...
                    public enum DelayDays: Codable, Equatable, Sendable {
                        ...
                        public init(from decoder: Decoder) throws {
                            ...
                            if let stringValue = try? container.decode(String.self), stringValue == "minimum" {
                                self = .minimum
                            } else if let intValue = try? container.decode(Int.self) {
                                self = .days(intValue)
                            } else {
                                throw DecodingError.dataCorruptedError(in: container, debugDescription: "Invalid delay_days value")
                            }
                        }
