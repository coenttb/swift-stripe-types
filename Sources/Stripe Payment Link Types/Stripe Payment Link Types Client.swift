...
extension Stripe.PaymentLinks {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var create:
      @Sendable (_ request: Stripe.PaymentLinks.Create.Request) async throws -> Stripe.PaymentLink
    ...
    public var lineItems:
      @Sendable (_ id: Stripe.PaymentLink.ID, _ request: Stripe.PaymentLinks.LineItems.Request)
