...
extension Stripe.Billing.Invoice.LineItems {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var list:
      @Sendable (_ invoiceId: String, _ request: Stripe.Billing.Invoice.LineItems.List.Request)
    ...
    @DependencyEndpoint
    public var addLines:
      @Sendable (_ invoiceId: String, _ request: Stripe.Billing.Invoice.LineItems.AddLines.Request)
