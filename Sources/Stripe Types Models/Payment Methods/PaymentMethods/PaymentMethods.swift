...
public struct PaymentMethodCardGeneratedFromPaymentMethodDetailsCardPresent: Codable, Hashable, Sendable {
...
public struct PaymentMethodCardGeneratedFromPaymentMethodDetailsCardPresentReceipt: Codable, Hashable, Sendable {
    ...
    public init(
        accountType: PaymentMethodCardGeneratedFromPaymentMethodDetailsCardPresentReceiptAccountType? = nil,
...
public struct PaymentMethodSepaDebitGeneratedFrom: Codable, Hashable, Sendable {
    ...
    public init(charge: Stripe.Charges.Charge.ID? = nil, setupAttempt: Stripe.Setup.Attempt.ID? = nil) {
