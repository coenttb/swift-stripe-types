...
public enum Either<A: Codable & Equatable & Sendable, B: Codable & Equatable & Sendable>: Codable, Equatable, Sendable {
    case left(A)
    case right(B)
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let a = try? container.decode(A.self) {
            ...
            throw DecodingError.typeMismatch(Either.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Could not decode Either"))
        }
    }
