...
extension Stripe.Billing.Invoices {
  ...
  public struct Client: Sendable {
    ...
    @DependencyEndpoint
    public var update:
      @Sendable (_ id: Stripe.Billing.Invoice.ID, _ request: Stripe.Billing.Invoices.Update.Request)
    ...
    @DependencyEndpoint
    public var pay:
      @Sendable (_ id: Stripe.Billing.Invoice.ID, _ request: Stripe.Billing.Invoices.Pay.Request)
        async throws -> Stripe.Billing.Invoice

    // https://docs.stripe.com/api/invoices/send.md
    @DependencyEndpoint
    public var send:
      @Sendable (_ id: Stripe.Billing.Invoice.ID, _ request: Stripe.Billing.Invoices.Send.Request)
        async throws -> Stripe.Billing.Invoice

    // https://docs.stripe.com/api/invoices/void.md
    @DependencyEndpoint
    public var void:
      @Sendable (_ id: Stripe.Billing.Invoice.ID, _ request: Stripe.Billing.Invoices.Void.Request)
        async throws -> Stripe.Billing.Invoice
  }
}
