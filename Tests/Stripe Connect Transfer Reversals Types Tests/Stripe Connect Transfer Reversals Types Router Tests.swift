...
struct ConnectTransferReversalsRouterTests {
    ...
    func testCreateTransferReversal() throws {
        ...
        // Verify URL
        #expect(urlRequest.url?.absoluteString == "https://api.stripe.com/v1/transfers/tr_1234567890/reversals")
        
        // Verify body contains form data
        #expect(urlRequest.httpBody != nil)
        
        // Parse back the API from the request
        let parsedAPI = try router.parse(request: urlRequest, baseURL: URL(string: "https://api.stripe.com")!)
    ...
    func testRetrieveTransferReversal() throws {
        ...
        let api = Stripe.Connect.Transfer.Reversals.API.retrieve(transferId: transferId, reversalId: reversalId)
        ...
        // Verify URL
        #expect(urlRequest.url?.absoluteString == "https://api.stripe.com/v1/transfers/tr_test/reversals/trr_test")
    ...
    func testUpdateTransferReversal() throws {
        ...
        let api = Stripe.Connect.Transfer.Reversals.API.update(transferId: transferId, reversalId: reversalId, request: request)
        ...
        // Verify URL
        #expect(urlRequest.url?.absoluteString == "https://api.stripe.com/v1/transfers/tr_update/reversals/trr_update")
    ...
    func testListTransferReversalsMinimal() throws {
        ...
        // Verify URL
        #expect(urlRequest.url?.absoluteString == "https://api.stripe.com/v1/transfers/tr_minimal/reversals")
    }
}