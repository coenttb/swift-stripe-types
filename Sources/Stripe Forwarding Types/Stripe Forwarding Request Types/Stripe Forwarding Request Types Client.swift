...
extension Stripe.Forwarding.Request {
    ...
    public struct Client: Sendable {
        ...
        @DependencyEndpoint
        public var create:
            @Sendable (_ request: Create.Request) async throws -> Stripe.Forwarding.Request

        // https://docs.stripe.com/api/forwarding/request/retrieve.md
        @DependencyEndpoint
        public var retrieve:
            @Sendable (_ id: Stripe.Forwarding.Request.ID) async throws -> Stripe.Forwarding.Request

        // https://docs.stripe.com/api/forwarding/request/list.md
        @DependencyEndpoint
        public var list:
            @Sendable (_ request: Stripe.Forwarding.Request.List.Request) async throws ->
